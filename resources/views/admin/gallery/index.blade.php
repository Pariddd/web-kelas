  ...
  <div class="flex-1 flex flex-col overflow-hidden">
    ...
    <main class="flex-1 overflow-y-auto p-6">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-6">
        <a href="{{ route('galleries.index') }}" class="group block">
          <div class="p-4 bg-[#1e293b] rounded-lg shadow border border-[#334155]
            ...
            <div class="p-3 bg-[#334155] rounded-full transition-colors duration-300 group-hover:bg-blue-600">
              <i class="fas fa-images text-2xl text-blue-300 group-hover:text-white"></i>
            </div>
            <div>
        ...
        <a href="{{ route('member.index') }}" class="group block">
          <div class="p-4 bg-[#1e293b] rounded-lg shadow border border-[#334155]
                      transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl
                      hover:border-green-400 flex items-center space-x-4">
