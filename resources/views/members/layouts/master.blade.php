  ...
  <script>
    (function(){
      ...
      function clearActive() {
        thumbs.forEach(t => {
          t.classList.remove('ring-2', 'ring-[#60a5fa]', 'scale-105');
          t.closest('div')?.classList.remove('ring-2', 'ring-[#60a5fa]'); 
        });
      }

      if (thumbs.length) {
        clearActive();
        thumbs[0].classList.add('ring-2','ring-[#60a5fa]','scale-105');
      }
      ...
      function changeImage(el) {
        ...
        main.src = el.src;
        clearActive();
        el.classList.add('ring-2','ring-[#60a5fa]','scale-105');
        el.closest('div')?.classList.add('ring-2','ring-[#60a5fa]');
      }
